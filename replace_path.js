...
fs.readFile('./build/index.html', 'utf8', function (err, data) {
    ...
    var result = result.replace(/\\.\/src\/js\/index\.js/g, 'https://calil.github.io/lf2021/js/index.js');
...
fs.readFile('./build/header.html', 'utf8', function (err, data) {
    ...
    var result = data.replace(/\/assets\/header\.css/g, 'https://calil.github.io/lf2021/assets/header.css');
    result = result.replace(/\/assets\/header\.js/g, 'https://calil.github.io/lf2021/assets/header.js');
    result = result.replace(/\.\/assets\//g, 'https://calil.github.io/lf2021/assets/');
